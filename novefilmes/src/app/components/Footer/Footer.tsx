...
export default function Footer() {
  return (
    <Box className="bg-neutral-50">
      <Grid
        className="flex items-center bg-neutral-50 w-[100%] max-w-[40vw] pl-10 pr-10 p-10 gap-[12vw] grid-cols-[auto_1fr]"
        gridArea={"header"}
      >
        <Box
          className="flex flex-col bg-neutral-50 w-[40vw] h-[30vw] items-center pl-[5vw]"
          style={{}}
        >
