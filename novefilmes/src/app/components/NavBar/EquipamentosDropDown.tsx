  ...
  return (
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        ...
        >
          <Link
            href="https://novefilmes.estoquenow.site/Shop/category/61276/01.-camera"
            passHref
          >
            <DropdownMenu.Item className="flex h-6 items-center border border-gray-300 rounded-sm pl-6 text-sm leading-none text-black cursor-pointer hover:bg-gray-200 hover:border-gray-300">
              Câmera
            </DropdownMenu.Item>
          </Link>
